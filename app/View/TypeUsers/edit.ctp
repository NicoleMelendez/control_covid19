<div class="typeUsers form">
	...
	<div class="card grey lighten-2 col m11 s10 offset-s1 black-text">
        ...
        <div style="margin:15px 0;">
            <h3><?php echo __('Editar tipo de usuario'); ?></h3>
            <p>TIPO DE USUARIO</p>   
        </div>
		...
		<?php echo $this->Form->create('TypeUser',array('class'=>'grey lighten-2 col m11 s10 offset-s1 grey-text')); ?>
            ...
            <div class="col s12">
                ...
                <?php echo $this->Form->postButton('guardar', ['controller' => 'type_users', 'action' => 'edit'], array('class'=>'right btn-flat waves-effect waves-teal grey lighten-1')); ?>
            </div>
            <!--fin botones accion-->
