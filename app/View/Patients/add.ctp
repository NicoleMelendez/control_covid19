...
<div class="card grey lighten-2 col m11 s10 offset-s1 black-text">
        ...
        <div style="margin:15px 0;">
            <h3><?php echo __('Nuevo paciente'); ?></h3>
		...
		<?php echo $this->Form->create('Patient', array('class'=>'grey lighten-2 col m11 s10 offset-s1 grey-text')); ?>
			...
			<?php echo $this->Form->postButton('guardar', ['controller' => 'patients', 'action' => 'add'], array('class'=>'right btn-flat waves-effect waves-teal grey lighten-1')); ?>
			</div>
			<!--fin botones accion-->
